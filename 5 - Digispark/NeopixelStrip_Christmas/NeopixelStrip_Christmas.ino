...
#define LEDS_PIN    1    // What output LEDS_PIN is the LED strip data line?
...
#define SCAN_FRAMES 100  // How many frames to stay on a single mode
...
int  mode;  // What display are we doing?
int frame; // How long have we been doing it?
...
Adafruit_NeoPixel strip = Adafruit_NeoPixel(100, 1, NEO_GRB + NEO_KHZ800);
